...
Running under WSL? See [WSL.md](WSL.md) - a fresh WSL distro is missing a couple of things a desktop Linux install normally has, and Ubuntu's default Chromium package doesn't work with Selenium at all.
